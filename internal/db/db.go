...
// dsn is the driver connection string for dbPath. Every connection to the
// file uses it, including the change watcher's, so they all share the same
// journal mode, busy timeout and locking behaviour.
//
