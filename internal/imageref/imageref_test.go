...
func TestRenameHTMLForms(t *testing.T) {
  ...
  src = "Home page.png"></picture>`, uses: 2, rewritten: 2},
		...
		{name: "only the first of a repeated attribute counts, as in a browser", in: `<img src="Login screen.png" SRC="Login screen.png" data-src="Login screen.png"><img src="Other.png" src="Login screen.png">`, want: `<img src="Home page.png" SRC="Login screen.png" data-src="Login screen.png"><img src="Other.png" src="Login screen.png">`, uses: 1, rewritten: 1},
